...
var _iconsSvg = require("url:../img/icons.svg"); // for parcel 2, static content need to include 'url:'
...
const showRecipe = async function() {
    try {
        ...
        <img src="${recipe.imageUrl}" alt="image of ${recipe.title}" class="recipe__img" />
      ...
      <div class="recipe__ingredients">
        ...
        ${recipe.ingredients.map((ing_obj)=>{
            return `
            <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
              </svg>
              <div class="recipe__quantity">${ing_obj.quantity ? ing_obj.quantity : ""}</div>
...
},{}]},["hycaY","aenu9"], "aenu9", "parcelRequire9bf5")
